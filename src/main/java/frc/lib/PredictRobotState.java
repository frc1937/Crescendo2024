...
public class RobotState {
     ...
     * 
     * @param timeInFuture How distant from now, in seconds, is the moment to predict the state
     *                     at
     */
    public static [Pose2d, ChassisSpeeds] predict(TimeInterpolatableBuffer<Pose2d> poseHistory, double futureTime) {
        ...
        Pose2d predictedPose = lastPoseSample.exp(predictedTwist);
