...
public class RotateToSpeaker extends SequentialCommandGroup {
    public RotateToSpeaker(DrivetrainSubsystem drivetrain) {
        addCommands(
                new RotateSpeaker(drivetrain)
        );
    }

    private static class RotateSpeaker extends Command {
        private final DrivetrainSubsystem drivetrain;
        private double virtualTargetDistance = 0;

        public RotateSpeaker(DrivetrainSubsystem drivetrain) {
        ...
        public void execute() {
            ...
            SmartDashboard.putNumber("DesiredAngle", virtualTargetDisplacement.getAngle().getDegrees());
        }
