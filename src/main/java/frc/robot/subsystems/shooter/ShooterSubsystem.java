...
import static frc.robot.GlobalConstants.CanIDConstants.FLYWHEEL_LEFT_ID;
import static frc.robot.GlobalConstants.CanIDConstants.FLYWHEEL_RIGHT_ID;
import static frc.robot.GlobalConstants.CanIDConstants.KICKER_ID;
...
public class ShooterSubsystem extends SubsystemBase {
    ...
    public void setPitchIdleMode(MotorProperties.IdleMode idleMode) {
        pitch.setIdleMode(idleMode);
    }
