...
public class AllianceUtilities {
    private static final double FIELD_LENGTH_METRES = 305.0;
    private static final double FIELD_WIDTH_METRES = 202.0;
    ...
    } //todo: GO over and do a fucking holocaust here

    private static Pose2d switchAlliance(Pose2d pose) {
        return new Pose2d(
                FIELD_LENGTH_METRES - pose.getX(),
                FIELD_WIDTH_METRES - pose.getY(),
